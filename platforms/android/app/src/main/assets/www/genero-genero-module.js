    ...
    GeneroPage.prototype.continue = function () {
        ...
        setTimeout(function () {
            _this.router.navigate([
                "/crianca/" + _this.tipoInter + "/" + _this.faixaEtaria + "/" + _this.acomodacao + "/" + _this.escolaridade + "/" + _this.pais + "/" + _this.nivel + "/" + _this.genero
            ]);
        }, 1200);
        setTimeout(function () {
            _this.sucesso = false;
